...
define(['app', 'lodash', 'js/eventBus', 'js/localeService'], function (app, _, eventBus) {
  ...
  var _buildTimeLovEntries = function _buildTimeLovEntries() {
    var lovEntries = [];
  ...
  var getLocale = function getLocale() {
    ...
    var localePlaceHolder = _localePlaceholders[locale];
  ...
  var _getTimePattern12Hr = function _getTimePattern12Hr() {
    if (!_regPattern12) {
  ...
  var _getTimePattern24Hr = function _getTimePattern24Hr() {
    if (!_regPattern24) {
  ...
  var _tokenizeTime = function _tokenizeTime(timeString) {
  ...
  var _getDateFormatByServerString = function _getDateFormatByServerString(dateFormat, includeDate, includeTime) {
    ...
    var localePlaceHolder = _localePlaceholders[getLocale()];
  ...
  var _setupDateTimeLocaleInfo = function _setupDateTimeLocaleInfo() {
    _localeSvc.getTextPromise('dateTimeServiceMessages').then(function (textBundle) {
      _i18n_anteMeridiem = textBundle.anteMeridiem;
      _i18n_postMeridiem = textBundle.postMeridiem;

      if (_$locale) {
        _$locale.id = getLocale();
        _$locale.DATETIME_FORMATS.AMPMS = [textBundle.anteMeridiem, textBundle.postMeridiem];
        _$locale.DATETIME_FORMATS.DAY = [textBundle.dayName_01, textBundle.dayName_02, textBundle.dayName_03, textBundle.dayName_04, textBundle.dayName_05, textBundle.dayName_06, textBundle.dayName_07];
        _$locale.DATETIME_FORMATS.MONTH = [textBundle.monthName_01, textBundle.monthName_02, textBundle.monthName_03, textBundle.monthName_04, textBundle.monthName_05, textBundle.monthName_06, textBundle.monthName_07, textBundle.monthName_08, textBundle.monthName_09, textBundle.monthName_10, textBundle.monthName_11, textBundle.monthName_12];
        _$locale.DATETIME_FORMATS.SHORTDAY = [textBundle.dayNameShort_01, textBundle.dayNameShort_02, textBundle.dayNameShort_03, textBundle.dayNameShort_04, textBundle.dayNameShort_05, textBundle.dayNameShort_06, textBundle.dayNameShort_07];
        _$locale.DATETIME_FORMATS.SHORTMONTH = [textBundle.monthNameShort_01, textBundle.monthNameShort_02, textBundle.monthNameShort_03, textBundle.monthNameShort_04, textBundle.monthNameShort_05, textBundle.monthNameShort_06, textBundle.monthNameShort_07, textBundle.monthNameShort_08, textBundle.monthNameShort_09, textBundle.monthNameShort_10, textBundle.monthNameShort_11, textBundle.monthNameShort_12];
      }
  ...
  var _getDateTime = function _getDateTime(dateToFormat) {
    var dateTime;
  ...
  exports.getJQueryDatePickerTextBundle = function () {
    ...
    if (_localeSvc) {
      return _localeSvc.getTextPromise('dateTimeServiceMessages').then(function (textBundle) {
        if (!textBundle) {
          return {};
        }
        ...
        return {
          ...
          monthNames: [textBundle.monthName_01, textBundle.monthName_02, textBundle.monthName_03, textBundle.monthName_04, textBundle.monthName_05, textBundle.monthName_06, textBundle.monthName_07, textBundle.monthName_08, textBundle.monthName_09, textBundle.monthName_10, textBundle.monthName_11, textBundle.monthName_12],
          monthNamesShort: [textBundle.monthNameShort_01, textBundle.monthNameShort_02, textBundle.monthNameShort_03, textBundle.monthNameShort_04, textBundle.monthNameShort_05, textBundle.monthNameShort_06, textBundle.monthNameShort_07, textBundle.monthNameShort_08, textBundle.monthNameShort_09, textBundle.monthNameShort_10, textBundle.monthNameShort_11, textBundle.monthNameShort_12],
          dayNames: [textBundle.dayName_01, textBundle.dayName_02, textBundle.dayName_03, textBundle.dayName_04, textBundle.dayName_05, textBundle.dayName_06, textBundle.dayName_07],
          dayNamesShort: [textBundle.dayNameShort_01, textBundle.dayNameShort_02, textBundle.dayNameShort_03, textBundle.dayNameShort_04, textBundle.dayNameShort_05, textBundle.dayNameShort_06, textBundle.dayNameShort_07],
          dayNamesMin: [textBundle.dayNameMin_01, textBundle.dayNameMin_02, textBundle.dayNameMin_03, textBundle.dayNameMin_04, textBundle.dayNameMin_05, textBundle.dayNameMin_06, textBundle.dayNameMin_07],
  ...
  exports.getDateTimeFilterFormat = function () {
    return exports.getDateFilterFormat() + _localePlaceholders[getLocale()].dateTimeSeparator + exports.getTimeFilterFormat();
  };
  /**
  ...
  exports.getDateFromTimeValue = function (timeValue) {
    ...
    var matches = trim.match(pattern); // _logMatches(pattern, matches, trim);
  ...
  app.factory('dateTimeService', ['$filter', '$locale', 'localeService', function ($filter, $locale, localeSvc) {
    _$filter = $filter;
    _$locale = $locale;
