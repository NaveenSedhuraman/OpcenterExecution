 ...
 *
 */
define(['lodash', 'js/splmTableUtils'], function (_, _t) {
  'use strict';
  /**
  ...
  var SPLMTableTraversal = function SPLMTableTraversal(tableElement) {
    ...
    self.queryContextMenuFromTable = function () {
      _elem = _table.getElementsByTagName(_t.const.ELEMENT_CONTEXT_MENU)[0].getElementsByClassName(_t.const.CLASS_AW_POPUP)[0];
      return this;
    };
