 ...
 */
define(['app', 'lodash', 'js/parsingUtils', 'js/uwDirectiveBaseUtils', 'soa/kernel/clientDataModel', 'js/dateTimeService', 'js/modelPropertyService', 'js/viewModelObjectService'], function (app, _, parsingUtils) {
  'use strict';
  /**
  ...
  app.factory('dynamicPropertyService', ['modelPropertyService', 'soa_kernel_clientDataModel', 'dateTimeService', 'viewModelObjectService', function (modelPropertySvc, cdm, dateTimeSvc, viewModelObjectSvc) {
    /**
    ...
    exports.createDynProperty = function (arrayObjs, n) {
      var output = [];
    ...
    exports.createSoaInput = function (arrayObjs, inArray) {
      var modelOutput = [];
    ...
    exports.processDataParseDefination = function (dynmData, data, response) {
    ...
    exports.filterObjects = function (response, filterProperty, path, expectedValue, filterInput) {
      var modelObjects = [];
