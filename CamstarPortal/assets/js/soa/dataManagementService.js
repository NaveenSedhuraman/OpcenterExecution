 ...
 */
define(['app', 'lodash', 'assert', 'js/eventBus', 'soa/kernel/clientDataModel', 'soa/kernel/propertyPolicyService', 'soa/kernel/soaService', 'soa/preferenceService', 'js/dateTimeService', 'js/localeService'], function (app, _, assert, eventBus) {
  'use strict';
  ...
  app.factory('soa_dataManagementService', ['$q', 'soa_kernel_clientDataModel', 'soa_kernel_propertyPolicyService', 'soa_kernel_soaService', 'soa_preferenceService', 'dateTimeService', 'localeService', function ($q, cdm, propPolicySvc, soaSvc, prefSvc, dateTimeSvc, localeSvc) {
    _$q = $q;
    _cdm = cdm;
