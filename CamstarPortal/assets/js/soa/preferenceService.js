...
'soa/kernel/soaService', 'js/appCtxService'], function (app, _, assert, eventBus) {
  'use strict';
  ...
  function setPrefs(prefName2Values) {
    ...
    return _soaSvc.postUnchecked('Administration-2012-09-PreferenceManagement', 'setPreferences2', body, {}).then(function () {
