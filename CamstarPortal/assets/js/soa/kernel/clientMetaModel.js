 ...
 */
define(['app', 'lodash', 'js/iconMapService'], function (app, _) {
  'use strict';
  /**
  ...
  var ModelType = function ModelType(modelTypeSOA) {
  ...
  var PropertyDescriptor = function PropertyDescriptor(propertyDescriptorSOA) {
  ...
  app.factory('soa_kernel_clientMetaModel', ['iconMapService', function (iconMapSvc) {
