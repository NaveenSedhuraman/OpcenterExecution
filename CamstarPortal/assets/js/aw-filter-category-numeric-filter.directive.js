...
'js/localeService', //
'js/aw-filter-category-numeric-range-filter.directive', //
'js/aw-filter-category-contents.directive', //
'js/filterPanelUtils'], function (app, _, eventBus) {
  'use strict';
  /**
  ...
  app.directive('awFilterCategoryNumericFilter', ['viewModelService', 'localeService', 'filterPanelUtils', function (viewModelSvc, localeSvc, filterPanelUtils) {
    return {
      transclude: true,
      restrict: 'E',
      scope: {
