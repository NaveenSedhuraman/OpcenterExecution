 ...
 */
define(['app', 'lodash', 'js/eventBus'], function (app, _, eventBus) {
  'use strict';
  ...
  exports.registerCtx = function (name, value) {
    exports.ctx[name] = value; // Announce app context registration
  ...
  exports.registerPartialCtx = function (path, value) {
    ...
    _.set(exports.ctx, path, value); // Announce app context registration
  ...
  exports.unRegisterCtx = function (name) {
    delete exports.ctx[name]; // Announce app context un-registration
  ...
  exports.updateCtx = function (name, value) {
    exports.ctx[name] = value; // Announce app context update
  ...
  exports.updatePartialCtx = function (path, value) {
    ...
    var currentCtx = _.get(exports.ctx, path); // This will typically be done using angular binding, so we don't want an event potentially every $digest


    if (value !== currentCtx) {
      var newCtx = _.set(exports.ctx, path, value); // Announce update
  ...
  app.factory('appCtxService', ['$rootScope', '$state', function ($rootScope, $state) {
