...
define([], function () {
  ...
  var setProgressBarLeftAndWidth = function setProgressBarLeftAndWidth() {
  ...
  exports.setProgressInterval = function () {
    if (itv === 0) {
  ...
  exports.clearProgressInterval = function () {
    clearInterval(itv); // setting back all the values to default
