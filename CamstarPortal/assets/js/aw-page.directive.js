 ...
 */
define(['app', 'js/eventBus', 'js/configurationService', 'js/appCtxService', 'js/aw-header.directive', 'js/aw-global-toolbar.directive', 'js/aw-tab.directive', 'js/aw-tab-container.directive', 'js/aw-command-bar.directive', 'js/aw.narrowMode.service', 'js/aw-logo.directive', 'js/aw-row.directive', 'js/aw-column.directive', 'js/aw-include.directive'], function (app, eventBus) {
  'use strict';
  /**
   *
  ...
  app.directive('awPage', ['$state', '$window', '$document', 'configurationService', 'appCtxService', 'narrowModeService', function ($state, $window, $document, cfgSvc, appCtxSvc, narrowModeSvc) {
    return {
      restrict: 'E',
