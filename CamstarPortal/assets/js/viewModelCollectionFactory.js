 ...
 */
define(['app', 'lodash', 'js/eventBus', 'js/logger', 'js/browserUtils', 'soa/kernel/clientDataModel', 'js/viewModelObjectService', 'js/uwPropertyService'], function (app, _, eventBus, logger, browserUtils) {
  ...
  app.factory('viewModelCollectionFactory', ['$q', 'soa_kernel_clientDataModel', 'viewModelObjectService', 'uwPropertyService', function ($q, cdm, viewModelObjectSvc, uwPropertySvc) {
    /**
    ...
    var ViewModelCollection = function ViewModelCollection(name) {
      var self = this;
      /**
      ...
      self.updateModelObjects = function (results, uidInResponse, preSelection, prepend) {
        ...
        if (!_.isEmpty(actualResults)) {
          ...
          _.forEach(actualResults, function (object) {
            ...
            if (results.objects) {
              uid = object.uid;
              vmObject = viewModelObjectSvc.createViewModelObjectFromPartialServerVMO(object);
            } else if (object.uid) {
              ...
              if (modelObj) {
                if (viewModelObjectSvc.isViewModelObject(object)) {
    ...
    exports.createViewModelCollection = function (name) {
