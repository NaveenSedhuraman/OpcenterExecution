...
/// <summary>
/// Summary description for dexMaterialsRequirement
/// </summary>
/// 
namespace Camstar.WebPortal.WebPortlets.Shopfloor
{
    public class dexMaterialsRequirement : MatrixWebPart
    {
        public dexMaterialsRequirement() { }
        ...
        protected CWC.CheckBox UseExpirationDate
        {
            get { return Page.FindCamstarControl("ComponentIssue_dexUseExpDates") as CWC.CheckBox; }
        }
        protected CWC.DateChooser ExpirationDate
        {
            get { return Page.FindCamstarControl("IAD_ExpirationDate") as CWC.DateChooser; }
        }

        protected CWC.CheckBox NoExpiration
        {
            get { return Page.FindCamstarControl("IAD_dexNoExpiration") as CWC.CheckBox; }
        }
        // Expiration Date if required
        ...
        public virtual void ScanFieldChanged(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(objectName))
            {
                ...
                var serviceInfo = new OM.ComponentIssueInquiry_Info
                {
                    ...
                    dexExpirationDate = new OM.Info(true)//Expiration Date Changes
                };
                ...
                if (resultStatus.IsSuccess)
                {
                    ...
                    if (!result.IsEmpty)
                    {
                        ...
                        //Expiration Date Changes - Start 
                        if (UseExpirationDate.IsChecked == true && result.Value.dexExpirationDate != null)
                        {
                            ExpirationDate.Data = (DateTime)result.Value.dexExpirationDate;
                            ExpirationDate.ReadOnly = true;
                            NoExpiration.Enabled = false;
                            NoExpiration.IsChecked = false;
                        }

                        //Expiration Date Changes - End
        ...
        public virtual ResponseData MaterialsRequirementGrid_RowSelected(object sender, JQGridEventArgs args)
        {
            if (SelectionGridData != null)
            {
                ...
                //Expiration Date Changes - Start
                if (UseExpirationDate.IsChecked == true)
                {
                    ExpirationDate.Visible = (bool)issueDetails.dexRequireExpiration;
                    ExpirationDate.ReadOnly = false;
                    NoExpiration.Visible = (bool)issueDetails.dexRequireExpiration;
                    NoExpiration.Enabled = true;
                    NoExpiration.IsChecked = false;
                }
        ...
        protected virtual void IssueComponentAction(CustomActionEventArgs e)
        {
            if (ExecuteData != null)
            {
                FrameworkSession session = FrameworkManagerUtil.GetFrameworkSession(HttpContext.Current.Session);
        ...
        protected virtual void SetUserDataEntryLayout(IssueDetailsTypeEnum type)
        {
            ...
            ExpirationDate.Visible = (type == IssueDetailsTypeEnum.LotAndStockpoint) || (type == IssueDetailsTypeEnum.Stockpoint);
            ExpirationDate.ReadOnly = !((type == IssueDetailsTypeEnum.LotAndStockpoint) || (type == IssueDetailsTypeEnum.Stockpoint));
            IssueDifferenceReason.Visible = IsIssueDifferenceReasonRequired();
            ...
            if (ExecuteData != null && ExecuteData.IssueDetails != null)
            {
                ...
                if (UseExpirationDate.IsChecked == true)
                {
                    ...
                    new OM.NamedObjectRef
                    {
                        ...
                        dexExpirationDate = ExpirationDate.Data != null ? (DateTime)ExpirationDate.Data : (DateTime?)null,
                        dexNoExpiration = (bool)NoExpiration.IsChecked
                    };
                }
                else
                {
